...
var DEBUG = false;
console.log("JS_VER", JS_VER);
switch(JS_MODULE) {
    case "hcl":
        if(DEBUG) {
            var list = ["static/js/lib/jquery-1.11.0.min.js",
                 "static/js/lib/metronic/jquery-migrate-1.2.1.min.js",
                 "static/js/lib/metronic/jquery-ui-1.10.3.custom.min.js",
                 "static/js/lib/metronic/bootstrap.min.js",
                 "static/js/lib/metronic/bootstrap-hover-dropdown.min.js",
                 "static/js/lib/metronic/jquery.slimscroll.min.js",
                 "static/js/lib/metronic/jquery.blockui.min.js",
                 "static/js/lib/metronic/jquery.cokie.min.js",
                 "static/js/lib/metronic/jquery.uniform.min.js",
                 "static/js/lib/metronic/bootstrap-switch.min.js",
                 "static/js/lib/metronic/metronic.js",
                 "static/js/lib/metronic/layout.js",
                 "static/js/lib/metronic/quick-sidebar.js",
                 "static/js/lib/metronic/demo.js",
                 "static/js/lib/metronic/index.js",
                 "static/js/lib/metronic/tasks.js",
                 "static/js/lib/angular/package/angular.min.js",
                 "static/js/lib/angular/package/angular-route.min.js",
                 "static/js/lib/angular/app.js?ver="+JS_VER,
                 "static/js/lib/angular/config.js?ver="+JS_VER,
                 "static/js/lib/angular/controllers.js?ver="+JS_VER];
        }else {
            var list = ["/static/new/js/lib.js?ver="+JS_VER,
                        "/static/new/js/analytics.js?ver="+JS_VER];
        }
    ...
    case "login":
        if(DEBUG) {
            var list = ["static/new/js/jquery-1.11.0.min.js",
                 "static/new/js/jquery-migrate-1.2.1.min.js",
                 "static/new/js/jquery-ui-1.10.3.custom.min.js",
                 "static/new/js/bootstrap.min.js",
                 "static/new/js/bootstrap-hover-dropdown.min.js",
                 "static/new/js/jquery.slimscroll.min.js",
                 "static/new/js/jquery.blockui.min.js",
                 "static/new/js/jquery.cokie.min.js",
                 "static/new/js/jquery.uniform.min.js",
                 "static/new/js/jquery.backstretch.min.js",
                 "static/new/js/metronic.js",
                 "static/new/js/layout.js",
                 "static/new/js/demo.js",
                 "static/new/js/lock.js",
                 "static/new/js/app/angular/angular.min.js"];
                 //"static/js/lib/angular/controllers.js"+JS_VER];

            console.log("list1", list);
            
        }else {            
            var list = ["static/new/js/lib.js?ver="+JS_VER,
                        "static/new/js/angular/controllers/login.js?ver="+JS_VER];
