...
error = function (code, stop) {
	var msg = 'Highcharts error #' + code + ': www.hirealchemy.com/errors/' + code;
	if (stop) {
		throw msg;
	}
	// else ...
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.hirealchemy.com/stock/2.0.4/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.hirealchemy.com/stock/2.0.4/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
	...
	credits: {
		enabled: true,
		text: 'Hirealchemy.com',
		href: 'http://www.hirealchemy.com',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
